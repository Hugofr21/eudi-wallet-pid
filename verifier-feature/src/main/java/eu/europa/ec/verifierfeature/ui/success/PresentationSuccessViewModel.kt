...
package eu.europa.ec.verifierfeature.ui.success
...
import eu.europa.ec.verifierfeature.interactor.PresentationSuccessVerifierInteractorGetUiItemsPartialState
import kotlinx.coroutines.launch
import org.koin.android.annotation.KoinViewModel

@KoinViewModel
class PresentationSuccessVerifierViewModel(
    private val interactor: PresentationSuccessVerifierInteractor,
    ...
    override fun doWork() {
        ...
        viewModelScope.launch {
            interactor.getUiItems().collect { response ->
                when (response) {
                    is PresentationSuccessVerifierInteractorGetUiItemsPartialState.Failed -> {
                        setState {
                            copy(
                                isLoading = false,
                            )
                    ...
                    is PresentationSuccessVerifierInteractorGetUiItemsPartialState.Success -> {
                        setState {
                            copy(
