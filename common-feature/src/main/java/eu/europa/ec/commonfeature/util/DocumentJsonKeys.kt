...
object DocumentJsonKeys {
    ...
    val ADDRESS: List<String> = listOf(RESIDENT_ADDRESS, RESIDENT_COUNTRY, RESIDENT_STATE, RESIDENT_CITY,
        RESIDENT_POSTAL_CODE,RESIDENT_STREET, RESIDENT_HOUSE_NUMBER
    )

    val  ISSUING: List<String> = listOf(ISSUING_AUTHORITY ,ISSUING_COUNTRY, ISSUING_JURISDICTION)
